//===========================================================================================================================
//	Program : Class to represent a graph, sample provided by Dr. Balaji
//===========================================================================================================================
...
public class Graph implements Iterable<Vertex> {
	...
	public int bfs(Vertex src) {
		//Changing the bfs to return -1 if not a tree, Condition 2 - to check if graph has a cycle, then it is not a tree
		int treeOrNot = 1;
		src.seen = true;
		src.d = 0;
	...
	// Run BFS from a given source node
	// Precondition: nodes have already been marked unseen
	public void bfsOddCycle(Vertex src) {
		for (Vertex v : this) {
			v.seen = false;
			v.d = 0;
			v.p = null;
